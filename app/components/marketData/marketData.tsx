...
const MarketData = () => {
    ...
    const btcMarketCapPercentage = marketData.data.market_cap_percentage.btc.toFixed(0);
    const ethMarketCapPercentage = marketData.data.market_cap_percentage.eth.toFixed(0);
    ...
    return (
      <nav className="flex justify-center my-2">
        {loadingStatus === "fulfilled" && (
          <ul className="inline-flex gap-2 text-xs">
