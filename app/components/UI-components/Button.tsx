  ...
  return (
    <motion.button
      ...
      className={`${
        ...
        disabled
          ? "cursor-not-allowed border-none bg-light-primary hover:bg-light-primary dark:bg-skeleton200 dark:text-dark-text hover:dark:bg-skeleton200 text-dark-darkBg"
